...
import plus.jdk.javassist.bytecode.AttributeInfo;
import plus.jdk.javassist.bytecode.AnnotationsAttribute;
import plus.jdk.javassist.bytecode.BadBytecode;
import plus.jdk.javassist.bytecode.Bytecode;
import plus.jdk.javassist.bytecode.ClassFile;
import plus.jdk.javassist.bytecode.CodeAttribute;
import plus.jdk.javassist.bytecode.ConstantAttribute;
import plus.jdk.javassist.bytecode.CodeIterator;
import plus.jdk.javassist.bytecode.ConstPool;
import plus.jdk.javassist.bytecode.Descriptor;
import plus.jdk.javassist.bytecode.EnclosingMethodAttribute;
import plus.jdk.javassist.bytecode.FieldInfo;
import plus.jdk.javassist.bytecode.InnerClassesAttribute;
import plus.jdk.javassist.bytecode.MethodInfo;
import plus.jdk.javassist.bytecode.ParameterAnnotationsAttribute;
import plus.jdk.javassist.bytecode.SignatureAttribute;
import plus.jdk.javassist.bytecode.annotation.Annotation;
import plus.jdk.javassist.compiler.AccessorMaker;
import plus.jdk.javassist.compiler.CompileError;
import plus.jdk.javassist.compiler.Javac;
import plus.jdk.javassist.expr.ExprEditor;
import plus.jdk.javassist.bytecode.annotation.AnnotationImpl;
