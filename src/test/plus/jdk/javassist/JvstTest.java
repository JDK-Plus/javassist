...
import plus.jdk.javassist.bytecode.*;
import plus.jdk.javassist.compiler.CompTest;
import plus.jdk.javassist.expr.*;
import plus.jdk.javassist.proxyfactory.ProxyFactoryTest;
import plus.jdk.javassist.proxyfactory.Tester;
import plus.jdk.javassist.runtime.Desc;
import plus.jdk.javassist.tools.reflect.LoaderTest;
...
public class JvstTest extends JvstTestRoot {
    ...
    public void testLoader() throws Exception {
        ...
        assertEquals(loader.loadClass("test1.Cflow").getClassLoader(),
                     loader.getParent());
        assertEquals(loader.loadClass("plus.jdk.javassist.Loader").getClassLoader(),
                     loader.getParent());
        assertEquals(loader.loadClass("plus.jdk.javassist.CtClass").getClassLoader(),
                     loader);
    }
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(StackMapTest.class);
        suite.addTestSuite(CompTest.class);
        suite.addTestSuite(SetterTest.class);
        suite.addTestSuite(InsertGap0.class);
